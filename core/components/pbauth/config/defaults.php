...
return [
    ...
    // Один вход на учётную запись: новый вход закрывает предыдущий. Логин с
    // паролем иначе передают по кругу, и одна подписка обслуживает десятерых.
    // Менеджерская сессия и вход менеджера под пользователем не в счёт.
