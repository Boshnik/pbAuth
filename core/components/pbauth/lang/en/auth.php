...
return [
    ...
    'social_state_error' => 'The sign-in did not complete. Please try again.',
    'social_failed' => 'The service did not confirm your identity. Please try again.',
    'social_taken' => 'That account is already linked to another user.',
    'social_email_unverified' => 'An account with this address already exists, and the service does not confirm the address belongs to you. Sign in with your password and link the network in your profile.',
    'social_linked' => 'The network is linked.',
    'social_unlinked' => 'The network is unlinked.',
    'social_not_linked' => 'That network is not linked.',
    'social_last_account' => 'This is your only way to sign in. Set a password first — use password recovery.',
    'social_expired' => 'Time is up. Please start again.',
    'social_confirm_email' => 'Almost done: confirm your address with the link we sent.',
    'social_email_title' => 'One more thing',
    'form_social_email_title' => 'Your email',
    'form_social_email_subtitle' => 'The service did not share your address. We need it to restore access and to write to you.',
    'form_social_email_submit' => 'Continue',
