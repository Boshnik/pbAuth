...
return [
    ...
    'social_state_error' => 'Вход не завершился. Попробуйте ещё раз.',
    'social_failed' => 'Служба не подтвердила вашу личность. Попробуйте ещё раз.',
    'social_taken' => 'Этот аккаунт уже привязан к другому пользователю.',
    'social_email_unverified' => 'Аккаунт с таким адресом уже есть, а служба не подтверждает, что адрес ваш. Войдите паролем и привяжите сеть в профиле.',
    'social_linked' => 'Сеть привязана.',
    'social_unlinked' => 'Сеть отвязана.',
    'social_not_linked' => 'Эта сеть не привязана.',
    'social_last_account' => 'Это ваш единственный способ входа. Сначала задайте пароль — через восстановление доступа.',
    'social_expired' => 'Время вышло. Начните заново.',
    'social_confirm_email' => 'Почти готово: подтвердите адрес по ссылке из письма.',
    'social_email_title' => 'Ещё один шаг',
    'form_social_email_title' => 'Ваша почта',
    'form_social_email_subtitle' => 'Служба не передала адрес. Он нужен, чтобы вы могли восстановить доступ и получать письма.',
    'form_social_email_submit' => 'Продолжить',
